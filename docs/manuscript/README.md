...
See [`../manuscript_authoring.md`](../manuscript_authoring.md)
for the full authoring workflow and evidence-language guidance.
Use [`../sources_provenance_ethics.md`](../sources_provenance_ethics.md)
...
[`../accessibility_reader_experience.md`](../accessibility_reader_experience.md)
and [`../publication_checklist.md`](../publication_checklist.md).
