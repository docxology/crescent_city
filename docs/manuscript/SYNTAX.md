...
Project-specific overlay on the canonical [`docs/guides/manuscript-semantics.md` in the template monorepo checkout](https://github.com/docxology/template/blob/main/docs/guides/manuscript-semantics.md) — read that file first; this file documents **crescent_city**-specific conventions.
...
roster in prose; the current roster is the sorted `docs/manuscript/*.md`
